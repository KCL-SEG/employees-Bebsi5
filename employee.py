...
class Employee:
    def __init__(self, name, contract_type, hours_worked=None, salary=None, bonus_commission=0, contract_commission=0, contract=0):
        self.name = name
    ...
    def get_pay(self):
        ...
        if self.bonus_commission:
            ...
            commission_pay = self.contract_commission * self.contract
        else:
            commission_pay = 0
    ...
    def __str__(self):
        ...
        if self.bonus_commission:
            ...
            string += ' and receives a commission for {} contract(s) at {}/contract'.format(
                self.contract_commission, self.contract)
...
renee = Employee('Renee', 'salary', salary=3000, contract_commission=4, contract=200)

# Jan works on a contract of 150 hours at 25/hour and receives a commission for 3 contract(s) at 220/contract. Their total pay is 4410.
jan = Employee('Jan', 'hourly', hours_worked=150, salary=25, contract_commission=3, contract=220)
